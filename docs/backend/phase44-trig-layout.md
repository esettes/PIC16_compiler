...
Phase 45 and Phase 46 expand the shared core point set, so helper size can increase. Resource fitting and page validation still treat `__rt_f32_sincos_core` as one math helper section with page-safe wrapper calls.
