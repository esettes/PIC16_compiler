...
- emit Phase 36/44 finite math calls as cataloged `math helper` contributions, except ISR-safe inline `fabsf`; Phase 44 internal trig wrappers, shared core, and ROM tables are reported as math/ROM contributions
