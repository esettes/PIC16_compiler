...
- emit Phase 36/43 finite math calls as cataloged `math helper` contributions, except ISR-safe inline `fabsf`; Phase 43 internal trig ROM tables are reported as ROM table contributions
