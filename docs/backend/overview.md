...
- emit Phase 36/45 finite math calls as cataloged `math helper` contributions, except ISR-safe inline `fabsf`; Phase 45 internal trig wrappers, shared core, accuracy policy, and ROM tables are reported as math/ROM contributions
