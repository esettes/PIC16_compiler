...
- emit Phase 36/48 finite math calls as cataloged `math helper` contributions, except ISR-safe inline `fabsf`; Phase 48 internal trig wrappers, shared core, accuracy policy, and ROM tables are reported as math/ROM contributions
