...
- Phase 36/37/41 finite math calls remain ordinary direct call IR nodes; the backend recognizes `fabsf`, `truncf`, `floorf`, `ceilf`, `roundf`, `sqrtf`, `fminf`, and `fmaxf` symbols and lowers them to runtime helpers
