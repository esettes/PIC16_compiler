...
- Phase 44/48 `sinf` / `cosf` / `tanf` use small wrappers around one finite table-backed shared core in radians; compact and balanced helpers are approximate and not libm replacements
