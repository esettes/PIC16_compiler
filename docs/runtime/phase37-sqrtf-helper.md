...
- math profile `compact` uses this helper; math profile `balanced` currently uses the same helper; math profile `precise` uses the larger table-refined helper variant expanded by Phase 40
