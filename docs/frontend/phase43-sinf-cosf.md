...
Dynamic validated points include `0`, `±pi/6`, `±pi/4`, `±pi/3`, `±pi/2`, `±2pi/3`, `±3pi/4`, `±5pi/6`, `±pi`, `±3pi/2`, and `±2pi` spellings used by the simulator tests. Phase 46 also validates deterministic scoped aliases through `±8pi`. Fallback outside documented table points is coarse and finite.
