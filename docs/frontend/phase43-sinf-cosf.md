...
Dynamic validated points include `0`, `±pi/4`, `±pi/2`, `±3pi/4`, `±pi`, `±3pi/2`, and `±2pi` spellings used by the simulator tests. Fallback outside those table points is coarse and finite.
