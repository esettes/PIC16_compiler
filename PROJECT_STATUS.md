...
# pic16cc — Technical Project Status

Detailed implementation status moved from the main README so its front page can stay concise and usage-focused.
...
- combined `sinf` / `cosf` / `tanf` programs select `combined_sincos_tan_core`, routing all three wrappers through `__rt_f32_sincos_core` and avoiding `__rt_f32_tan_core`
- reports, maps, and listings show `Trig runtime strategy: sincos_shared_core`, `isolated_tan_core`, or `combined_sincos_tan_core`
- balanced combined trig drops from the Phase 49 split-core shape of `8005 / 8192` words to roughly `7250 / 8192` words; this is a clear reduction but still not a small-target trig budget
...
- `fabsf` may be used in ISRs only when it lowers inline; other math helpers, including `sqrtf`, `fminf`, `fmaxf`, `sinf`, `cosf`, and `tanf`, remain rejected in ISRs
- no `double`, no full ISO C `math.h`, no `atanf`/`powf`/`expf`/`logf`, no errno/fenv, and no IEEE NaN/Inf promise
...
- [docs/runtime/phase44-trig-shared-core.md](docs/runtime/phase44-trig-shared-core.md)
- [docs/backend/phase44-trig-layout.md](docs/backend/phase44-trig-layout.md)
- [docs/runtime/phase45-trig-accuracy-harness.md](docs/runtime/phase45-trig-accuracy-harness.md)
- [docs/runtime/phase45-trig-range-reduction.md](docs/runtime/phase45-trig-range-reduction.md)
- [docs/runtime/phase45-trig-profile-accuracy.md](docs/runtime/phase45-trig-profile-accuracy.md)
- [docs/runtime/phase46-trig-moderate-range-reduction.md](docs/runtime/phase46-trig-moderate-range-reduction.md)
- [docs/runtime/phase46-trig-range-validation.md](docs/runtime/phase46-trig-range-validation.md)
- [docs/runtime/phase47-trig-core-compaction.md](docs/runtime/phase47-trig-core-compaction.md)
- [docs/runtime/phase47-trig-alias-compaction.md](docs/runtime/phase47-trig-alias-compaction.md)
- [docs/frontend/phase48-tanf.md](docs/frontend/phase48-tanf.md)
- [docs/ir/phase48-tanf-lowering.md](docs/ir/phase48-tanf-lowering.md)
- [docs/runtime/phase48-tanf-helper.md](docs/runtime/phase48-tanf-helper.md)
- [docs/runtime/phase48-tanf-accuracy-policy.md](docs/runtime/phase48-tanf-accuracy-policy.md)
- [docs/backend/phase48-tanf-resource-cost.md](docs/backend/phase48-tanf-resource-cost.md)
- [docs/runtime/phase49-tanf-cost-isolation.md](docs/runtime/phase49-tanf-cost-isolation.md)
- [docs/backend/phase49-trig-helper-splitting.md](docs/backend/phase49-trig-helper-splitting.md)
- [docs/runtime/phase50-combined-trig-budget.md](docs/runtime/phase50-combined-trig-budget.md)
- [docs/backend/phase50-trig-runtime-strategies.md](docs/backend/phase50-trig-runtime-strategies.md)
