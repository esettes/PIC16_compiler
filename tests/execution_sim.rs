...
const PHASE48_TAN_COMPACT_ABS_TOLERANCE: f32 = 0.20;
const PHASE48_TAN_BALANCED_ABS_TOLERANCE: f32 = 0.10;
const PHASE48_TAN_SAT_BITS: u32 = 0x46FF_FE00;
const PHASE48_NEG_TAN_SAT_BITS: u32 = 0xC6FF_FE00;
...
fn phase46_trig_points() -> &'static [(&'static str, &'static str, f32)] {
    ...
    &[
        ...
        ("pi2", "1.5707963f", FRAC_PI_2),
        ("twopi3", "2.0943952f", 2.0 * FRAC_PI_3),
        ("threepi4", "2.3561945f", 3.0 * FRAC_PI_4),
        ("fivepi6", "2.6179938f", 5.0 * FRAC_PI_6),
        ("pi", "3.1415927f", PI),
        ("negpi6", "-0.5235988f", -FRAC_PI_6),
        ("negpi4", "-0.7853982f", -FRAC_PI_4),
        ("negpi2", "-1.5707963f", -FRAC_PI_2),
        ("negpi", "-3.1415927f", -PI),
        ("twopi", "6.2831855f", TAU),
        ("negtwopi", "-6.2831855f", -TAU),
